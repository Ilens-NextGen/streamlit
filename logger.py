...
from utils import getlistenv, getenv, getboolenv


debug = getboolenv("DEBUG", False)
log_fmt = getenv(
    "LOG_FORMAT", f"[%(asctime)s] [UI Module] [%(levelname)s] [%(name)s] %(message)s"
)
...
log_file = getenv("LOG_FILE", "ilens_log")
...
class CustomLogger:
    def __init__(
        self, logger_name, file_logging=log_to_file, file_name="ilens_log"
    ):
